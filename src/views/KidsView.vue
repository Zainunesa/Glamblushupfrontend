      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h1 class="holographic-heading">Kids' Makeup</h1>
          </div>
        </div>
      </div>
    </header>
...
export default {
  ...
  async created() {
    try {
      const response = await fetch("http://localhost:3001/products/category/kids");
      const data = await response.json();
      console.log(data); 

      // Seting default sale property if it doesn't exist
